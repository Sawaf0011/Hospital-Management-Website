...
class Chatlist extends Component
{
    ...
    public function getUsers(Conversation $conversation, $request)
    {
        ...
        {
            if($conversation->sender_email == Doctor::where('email', $this->auth_email)->value('email'))
        {
        ...
        else
        {
            ...
            if($conversation->sender_email == Patient::where('email', $this->auth_email)->value('email'))
            {
