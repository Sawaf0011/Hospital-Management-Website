    ...
    @section('page-header')
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex"><h4 class="content-title mb-0 my-auto">Chats</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">\ recent chats</span></div>
            </div>
        </div>
        <!-- breadcrumb -->
    @endsection
                ...
                <div class="card">
                    <div class="main-content-left main-content-left-chat">
                        <nav class="nav main-nav-line main-nav-line-chat">
                            <a class="nav-link active" data-toggle="tab" href="">Recent Chats</a>
                        </nav>
