                                    ...
                                    <td>
                                        @if ($groupItem['is_saved'])
                                            <button class="btn btn-sm btn-primary"
                                                    wire:click.prevent="editService({{$index}})">Edit</button>
                                        @elseif ($groupItem['service_id'])
                                            <button class="btn btn-sm btn-success mr-1"
                                                    wire:click.prevent="saveService({{$index}})">Confirm</button>
                                        @endif
                                        <button class="btn btn-sm btn-danger"
                                                wire:click.prevent="removeService({{$index}})">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
