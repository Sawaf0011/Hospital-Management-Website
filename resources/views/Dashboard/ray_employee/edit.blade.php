<!-- Modal -->
<div class="modal fade" id="edit{{ $ray_employee->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('ray_employee.update', $ray_employee->id) }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <label for="exampleInputPassword1">{{trans('Dashboard/sections_trans.Email')}}</label>
                    <input type="email" value="{{$ray_employee->email}}" name="email" class="form-control"><br>

                    <label for="exampleInputPassword1">{{trans('Dashboard/sections_trans.Password')}}</label>
