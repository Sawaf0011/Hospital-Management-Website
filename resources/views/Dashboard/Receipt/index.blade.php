...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Accounts</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Receipts</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                            ...
                            @foreach($receipts as $receipt)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('Receipt.show',$receipt->id)}}" class="btn btn-primary btn-sm" target="_blank" title="Print Receipt"><i class="fas fa-print"></i></a>
                                    </td>
                                </tr>
