                            ...
                            <div class="panel panel-primary tabs-style-1">
                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border-top-0 border">
                                    <div class="tab-content">
                                        ...
                                        {{-- End Receipts for Patient  --}}


                                        {{-- Start Payment Accounts for Patient --}}
                                        ...
                                        {{-- End Payment Accounts for Patient --}}


                                        <div class="tab-pane" id="tab5">
                                            <p>Presentium voluptatum deleniti atque corrquas molestias excepturi sint
                                        ...
                                        <div class="tab-pane" id="tab6">
                                            <p>Presentium et quas molestias excepturi sint occaecati cupiditate non
                                                provident,</p>
                                            <p class="mb-0">Similique sunt in culpa qui officia deserunt mollitia animi,
                                                id est laborum et dolorum fuga. Et harum quidem rerum facilis est et
                                                expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi
