                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a href="{{route('Payment.create')}}" class="btn btn-primary" role="button"
                           aria-pressed="true">Add New Voucher</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            @foreach($payments as $payment)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('Payment.show',$payment->id)}}" class="btn btn-primary btn-sm" target="_blank" title="Print Payment Voucher"><i class="fas fa-print"></i></a>
