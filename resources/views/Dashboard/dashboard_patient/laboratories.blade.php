...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Patient Operations</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Laboratory</span>
            </div>
        </div>
    </div>
    <!-- /Breadcrumb -->
                    ...
                    <div class="table-responsive">
                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                            ...
                            <tr>
                                ...
                                <th>Required</th>
                                <th >Doctor Name</th>
                                <th>Laboratory Doctor Name</th>
                                <th>Laboratory Note</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
