    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('invoices.patient')}}">Invoice List</a></li>
                    <li><a class="slide-item" href="{{route('laboratories.patient')}}">Laboratories</a></li>
                    <li><a class="slide-item" href="{{route('rays.patient')}}">Radiology</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('list.doctors')}}">Doctor List</a></li>
